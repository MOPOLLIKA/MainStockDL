...
if __name__ == "__main__":
      ...
      earlyStopping1 = keras.callbacks.EarlyStopping("val_loss", patience=2, restore_best_weights=True)
      #modelBase.fit(x_train, y_train, batch_size=1, epochs=50, verbose=0, callbacks=earlyStopping1, validation_split=0.1)

      model = CreateBasicModel((timestep, numberOfValues), 128)
      earlyStopping2 = keras.callbacks.EarlyStopping("val_loss", patience=5, restore_best_weights=True)
      model.fit(x_train, y_train, batch_size=1, epochs=50, verbose=0, callbacks=earlyStopping2, validation_split=0.1)
