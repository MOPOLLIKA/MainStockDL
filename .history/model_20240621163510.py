...
Plans:
      ...
      1. Reduce the data. Leave only necessary indicators and try to combine them, so that only 3 values are left - price, volume and indicator feature, with input and output masks for 
