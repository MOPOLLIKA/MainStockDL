...
def FetchIndicators(ticker="IBM", interval="DAILY", series_type="close", apikey="U2NTP7T784ZP3OJK"):
  ...
  aroon = adunpackJSONIntoValues(requests.get(f"https://www.alphavantage.co/query?function=AROON&symbol={ticker}&interval={interval}&time_period=25&apikey={apikey}").json(), "AROON")
