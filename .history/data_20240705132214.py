...
def PredictValues2(number, model: keras.Model, entries, timestep):
      valuesPredicted = {}
      predictions = []
      entriesTransformed = TransformEntries(entries, timestep, stride=1)
      predictionInput = list(entriesTransformed.values())[-timestep:]
      ...
      for _ in range(number):
            ...
            predictionInput = entries[-numberOfValuesFromEntries:] + predictions
...
if __name__ == "__main__":
      ...
      entriesTransformed = TransformEntries(entries, timestep, number)
