...
def TrainBaseNumberModel(number):
      ...
      checkpoints = keras.callbacks.ModelCheckpoint(filepath="/Users/MOPOLLIKA/python_StockDL/ModelCheckpoints/base{number}.weights.h5", save_weights_only=True, verbose=1)
