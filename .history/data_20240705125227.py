...
def TrainModel(model, entriesTransformed):
      
      return True

def PredictValues1(number, model: keras.Model, entriesTransformed):
      """
...
def PredictValues2(number, model: keras.Model, entries):
      valuesPredicted = {}
      predictionInput = list(entries.values())[-number:]
      timeDifference = TimeDifferen
...
if __name__ == "__main__":
      ...
      prediction = PredictValues1(number, model, entriesTransformed)
      print(prediction)
