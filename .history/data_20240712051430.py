...
def TrainBaseNumberModel(numberOfTickers, numberOfValues, timestep, lstm=False):
      ...
      for ticker in list(stocksEntries.keys())[0:numberOfTickers]:
            ...
            model.fit(x_train, y_train, batch_size=1, epochs=20, verbose=1, callbacks=checkpoints, validation_split=0.1)
      return model
...
def main() -> None:
      ...
      for ticker in stocksEntries:
            ...
            model.fit(x_train, y_train, batch_size=1, epochs=3, validation_split=0.1, callbacks=earlyStopping, verbose=2)
