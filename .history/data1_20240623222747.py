...
def TransformEntries(entries, timestep):
      # Stopped here. The next step is to implement timestep feature and test different indicators to see how it will improve the accuracy and record everything to 
      pass
