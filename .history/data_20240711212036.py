...
def CreateLstmModel(inputShape, units):
      ...
      model.compile(
            optimizer=keras.optimizers.Adam(learning_rate=1e-3), # 1e-4
            loss=keras.losses.MeanAbsolutePercentageError()
      )
      #model.summary()
      return model
...
if __name__ == "__main__":
      ...
      for ticker in stocksEntries:
            ...
            model.fit(x_train, y_train, batch_size=1, epochs=20, callbacks=earlyStopping, validation_split=0.1, verbose=1)
