...
def StandardizeArraySK(array, nValues):
      ...
      if numberOfChunks == 0:
            ...
            standardized = ToList(scaler.transform(array))
      ...
      for index in range(numberOfChunks):
            ...
            standardized = ToList(scaler.transform(chunk))
            arrayNew += list(standardized)
      ...
      if int(number) < number:
            ...
            standardized = ToList(scaler.transform(chunkLast))
            arrayNew += list(standardized)
      print(arrayNew)
      return arrayNew
