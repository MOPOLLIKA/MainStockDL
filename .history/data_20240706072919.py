...
if __name__ == "__main__":
      ...
      cpCallback = keras.callbacks.ModelCheckpoint(filepath="/Users/MOPOLLIKA/python_StockDL/ModelCheckpoints", save_weights_only=True, verbose=1)
      for ticker in stocksEntries:
            entries = stocksEntries[ticker]
            entriesTransformed = TransformEntries(entries, timestep, )
