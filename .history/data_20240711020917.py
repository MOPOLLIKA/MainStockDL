...
def TrainBaseNumberModel(numberOfTickers, numberOfValues, timestep, lstm=False):
      ...
      checkpoints = keras.callbacks.ModelCheckpoint(filepath=f"/Users/MOPOLLIKA/python_StockDL/ModelCheckpoints/base{numberOfTickers}_{numberOfValues}{'_lstm' if }.weights.h5", save_weights_only=True, verbose=1)
