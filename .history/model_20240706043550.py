...
Plans:
      ...
      1. Collect the accuracy data for all the NASDAQ tickers using 3 values and 1 value entries with the basic model.
            ...
            1. Abandon the 3 value strategy and complete the 1 value prediction method, and plotting method to create required graphs of actual/predicted(covered+uncovered) data
      3. Create a uniform model which was trained on all the NASDAQ tickers and add its weight to the prediction of values in the main model architecture
      4. Start fetching real world data and reshaping it into model appropriate format to then do some learning and comparing of the effectiveness
      5. Learn github and push all of the files there to become open-source
      6. Draw conclusions from the work done
"""
