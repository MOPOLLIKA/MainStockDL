...
def TrainBaseNumberModel(numberOfTickers, numberOfValues, timestep):
      ...
      for ticker in list(stocksEntries.keys())[0:numberOfTickers]:
            ...
            model.fit(x_train, y_train, batch_size=1, epochs=100, verbose=1, callbacks=[earlyStopping, checkpoints], validation_split=0.1)
      return model
...
if __name__ == "__main__":
      ...
      model = CreateLstmModel((timestep, numberOfValues), 75)
