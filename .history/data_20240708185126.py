...
def GetStocksEntries():
      ...
      for ticker in tickers:
            ...
            try:
                  ...
                  print(f"Number of indicator requests has exceeded the limit of AlphaVantage. The last ticker loaded is: {list(stocksEntries.keys())[-1]}.") if stocksEntries else True
