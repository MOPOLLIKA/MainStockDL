...
def TrainBaseNumberModel(numberOfTickers, numberOfValues, timestep, lstm=False):
      ...
      for ticker in list(stocksEntries.keys())[0:numberOfTickers]:
            ...
            model.fit(x_train, y_train, batch_size=1, epochs=3, verbose=1, callbacks=checkpoints, validation_split=0.1)
      return model
...
def GetModelBaseNumberBasic(timestep, numberOfValues, numberOfTickers):
...
if __name__ == "__main__":
      ...
      """
      modelBase = GetModelBaseNumberBasic(timestep, numberOfValues, numberOfTickers)
      ...
      PlotPredictionGraphFor1Values(modelVase, x_train, entries)
