...
if __name__ == "__main__":
      ...
      model = CreateLstmModel((timestep, numberOfValues), 128)
      earlyStopping = keras.callbacks.EarlyStopping("val_loss", patience=5, restore_best_weights=True)
      model.fit(x_train, y_train, batch_size=1, epochs=100, verbose=1, callbacks=earlyStopping, validation_split=0.1)
