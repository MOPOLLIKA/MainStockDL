...
def PlotPredictionGraph(model: keras.Model, x_train, y_train, entries, predictionUncovered):
      ...
      print([type(xPredicted[-1]), type(xUncovered[0])], [type(yPredicted[-1]), type(yUncovered[0])])
      plt.plot([xPredicted[-1], xUncovered[0]], [yPredicted[-1], yUncovered[0][0]], color="green", linestyle="-")
