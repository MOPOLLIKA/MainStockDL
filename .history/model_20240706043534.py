...
Plans:
      ...
      2. Abandon the 3 value strategy and complete the 1 value prediction method, and plotting method to create required graphs of actual/predicted(covered+uncovered) data
