...
def TrainBaseNumberModel(numberOfTickers):
      ...
      checkpoints = keras.callbacks.ModelCheckpoint(filepath=f"/Users/MOPOLLIKA/python_StockDL/ModelCheckpoints/base{number}.weights.h5", save_weights_only=True, verbose=1)
...
if __name__ == "__main__":
      ...
      model = CreateBasicModel((timestep, numberOfValue))
