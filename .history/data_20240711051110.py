...
if __name__ == "__main__":
      ...
      entries = CsvToEntries("/Users/MOPOLLIKA/python_StockDL/globaltemperature/GlobalLandTemperatures_GlobalTemperatures.csv")
      ...
      modelRandom.evaluate(x_train, y_train, batch_size=1)
      ...
      PlotPredictionGraphFor1Values(modelRandom, x_train, entries)
