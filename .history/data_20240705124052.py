...
def PredictValues(number, model: keras.Model, entriesTransformed):
      """
...
if __name__ == "__main__":
      timestep = 4
      number = 4
      data = FetchDataYF(ticker="AAPL", interval="1mo")
      indicators = FetchIndicators(ticker="AAPL", interval="MONTHLY")
