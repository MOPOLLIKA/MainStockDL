...
if __name__ == "__main__":
      ...
      entries = TransformDataIntoSequence1(data, indicators)model2 = ConvolutionalModel(32, 3)model1 = CreateBasicModel((None, 3, ), 64) prediction = PredictValues1(4, model, entries)
      print(prediction)
