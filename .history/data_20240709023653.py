...
def GetStocksEntries(numberOfValues=3):
      ...
      if ad["Information"] == "Thank you for using Alpha Vantage! Our standard API rate limit is 25 requests per day. Please subscribe to any of the premium plans at https://www.alphavantage.co/premium/ to instantly remove all daily rate limits."
...
if __name__ == "__main__":
      ...
      for ticker in stocksEntries:
            ...
            modelBase = CreateBasicModel((timestep, numberOfValues), 128)
            modelBase.load_weights("/Users/MOPOLLIKA/python_StockDL/ModelCheckpoints/base20.weights.h5")
