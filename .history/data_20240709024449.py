...
if __name__ == "__main__":
      ...
      for ticker in stocksEntries:
            ...
            earlyStopping = keras.callbacks.EarlyStopping("val_loss", patience=2, restore_best_weights=True)
            modelBase.fit(x_train, y_train, batch_size=1, epochs=50, callbacks=earlyStopping, validation_split=0.1, verbose=0)
