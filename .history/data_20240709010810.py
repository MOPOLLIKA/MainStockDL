...
def PredictValuesFor3Values(number, model: keras.Model, entries):
      """
...
if __name__ == "__main__":
      ...
      results = []
      for ticker in list(stocksEntries.keys())[0:20]:
            entries = stocksEntries[ticker]
      ...
      """
      modelBase20 = CreateBasicModel((number, numberOfValues), 128)
      modelBase20.load_weights("/Users/MOPOLLIKA/python_StockDL/ModelCheckpoints/base20.weights.h5")
