...
def PlotPredictionGraph3Values(model: keras.Model, x_train, y_train, entries, predictionUncovered, numberOfValues=3):
      ...
      for entryTrain in x_train:
            modelInput = np.reshape(entryTrain, (1, -1, numberOfValues))
      ...
      inputLeft = np.reshape(sequenceLeft, (1, timestep, numberOfValues)) # (1, timestep, 1)
...
if __name__ == "__main__":
      ...
      modelBase20 = CreateBasicModel((number, 3), 128)
