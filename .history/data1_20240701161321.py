...
from data import FetchDataYF, FetchIndicators, StandardizeArrays1, ToList
...
def TransformDataIntoSequence1(data, indicators):
      ...
      for index in range(len(volumesStandardized1)):
            print(f"1: {volumesStandardized1[index]}, 2: {volumesStandardized2[index]}")
      return entries
...
if __name__ == "__main__":
      ...
      entries = TransformEntries(entries, 3, 1)
