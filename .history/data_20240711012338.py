...
def TrainBaseNumberModel(numberOfTickers, numberOfValues, timestep, lstm=False):
      ...
      model = CreateBasicModel((timestep, numberOfValues), 128) if lstm == False else CreateLstmModel((timestep, numberOfTickers), 64)
...
if __name__ == "__main__":
      ...
      TrainBaseNumberModel(numberOfTickers, numberOfValues, timestep, lstm=)
