...
def CreateModelBaseNumberBasic(timestep, numberOfValues, numberOfTickers):
...
if __name__ == "__main__":
      ...
      numberOfTickers = 20
      stocksEntries = GetStoksEntries()
      
      entries = CreateEntries("AAPL", numberOfValues)
      x_train, y_train = CreateDataset1(entries, timestep, numberOfValues)

      #modelBase = CreateModelBaseNumberBasic(timestep, numberOfValues, numberOfTickers)
