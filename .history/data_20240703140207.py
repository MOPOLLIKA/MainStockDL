...
if __name__ == "__main__":
	...
	model2 = CreateConvolutionalModel((batch_size, timestep, 3), 32, 3)
	model2.compile(
		optimizer=keras.optimizers.Adam(learning_rate=1e-3),
		loss=keras.losses.MeanSquaredError()
	)
	model2.summary()
	model2.fit(x_train, y_train, batch_size=batch_size, epochs=30, verbose=1, callbacks=keras.callbacks.EarlyStopping("val_loss", patience=5), validation_split=0.1)
