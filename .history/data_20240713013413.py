...
def main() -> None:
      ...
      modelBase = CreateLstmModel((timestep, 1) 64)# LoadModelBaseNumberLstm(timestep, numberOfValues, numberOfTickers)
      ...
      for ticker in stocksEntries:
            ...
            modelBase.evaluate(np.reshape(x_train, (-1, 3, 1)), y_train)
