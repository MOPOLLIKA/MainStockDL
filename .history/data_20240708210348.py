...
def CreateDataset1(ticker, timestep, numberOfValues):
...
if __name__ == "__main__":
      ...
      entries = CreateEntries(ticker, numberOfValues)
      x_train, y_train = CreateDataset1(ticker, timestep, numberOfValues)
      ...
      model.fit(x_train, y_train, batch_size=1, epochs=50, callbacks=earlyStopping, validation_split=0.1)
