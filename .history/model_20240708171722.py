...
Plans:
      ...
      In addition to the tables, there should be a plotting function made to plot the actual, predicted and uncovered predicted data and then after several days 
"""
