...
def PredictValuesFor3Values(numberOfValuesToPredict, model: keras.Model, entries, numberOfValues):
      """
...
def PredictValuesFor1Values(numberOfValuesToPredict):
      pass
...
if __name__ == "__main__":
      ...
      prediction = PredictValuesFor3Values(numberOfValuesToPredict, modelBase, entries, numberOfValues)
      print(prediction)
